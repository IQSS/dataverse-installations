#Base dir /Users/rmp553/Documents/iqss-git/miniverse/miniverse
#STATICFILES_DIRS ['/Users/rmp553/Documents/iqss-git/miniverse/miniverse/static']
...
class Dataset(models.Model):
    ...
    citationdatedatasetfieldtype = models.ForeignKey('Datasetfieldtype', blank=True, null=True)
...
class Datasetversion(models.Model):
    ...
    dataset = models.ForeignKey('Dvobject', unique=True, blank=True, null=True)
    termsofuseandaccess = models.ForeignKey('Termsofuseandaccess', blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'datasetversion'
        unique_together = (('dataset_id', 'versionnumber', 'minorversionnumber'),)
...
class Dataversefieldtypeinputlevel(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('dataverse_id', 'datasetfieldtype_id'),)
...
class FromCsvTable(models.Model):
    date = models.DateField(db_column='Date')  # Field name made lowercase.
    time = models.TimeField(db_column='Time')  # Field name made lowercase.
    crime_type = models.CharField(db_column='Crime_Type', max_length=5)  # Field name made lowercase.
    crime_type_description = models.CharField(db_column='Crime_Type_Description', max_length=28)  # Field name made lowercase.
...
class Interactivedataset(models.Model):
    contactemail = models.CharField(max_length=255)
    contactname = models.CharField(max_length=255)
    created = models.DateTimeField(blank=True, null=True)
    explorebuttonopensnewwindow = models.NullBooleanField()
    explorebuttonurl = models.CharField(max_length=255, blank=True, null=True)
    serviceactive = models.NullBooleanField()
    servicedescription = models.CharField(max_length=255, blank=True, null=True)
    servicedownmessage = models.CharField(max_length=255, blank=True, null=True)
    serviceinactivemessage = models.CharField(max_length=255, blank=True, null=True)
    servicename = models.CharField(unique=True, max_length=255)
    updated = models.DateTimeField(blank=True, null=True)
    visualizationurl = models.CharField(max_length=255, blank=True, null=True)
    dataset = models.ForeignKey(Dvobject, unique=True, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'interactivedataset'
...
class Remoteapiendpoint(models.Model):
    apiencryptedpassword = models.CharField(max_length=255, blank=True, null=True)
    apiendpointurl = models.CharField(max_length=255)
    apiparameters = models.CharField(max_length=255, blank=True, null=True)
    apiusername = models.CharField(max_length=255, blank=True, null=True)
    usepostrequest = models.NullBooleanField()
    interactivedataset = models.ForeignKey(Interactivedataset, unique=True, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'remoteapiendpoint'
